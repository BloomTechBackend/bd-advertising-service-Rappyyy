...
public class AdvertisementSelectionLogic {
        ...
        if (StringUtils.isEmpty(marketplaceId)) {
            ...
            if (CollectionUtils.isNotEmpty(contents)) {
                List<AdvertisementContent> eligibleAds = contents.stream()
                        .filter(ad -> isCustomerEligible(ad, new RequestContext(customerId, marketplaceId)))
    ...
    private boolean isCustomerEligible(AdvertisementContent advertisementContent, RequestContext requestContext) {
        TargetingGroup targetingGroup = (TargetingGroup) targetingGroupDao.get(advertisementContent.getContentId());
